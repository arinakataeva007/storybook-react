...
const Template = args => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_feature_choice_menu_item_component__WEBPACK_IMPORTED_MODULE_1__.MenuItem, {
  ...
  childrenPopUp: args.active && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_feature_choice_menu_item_component__WEBPACK_IMPORTED_MODULE_1__.MenuItem, {
    theme: args.theme,
...
LightTheme.parameters = {
  ...
  docs: {
    ...
    source: {
      originalSource: "args => <MenuItem {...args} childrenIcon={<BaseButton data-position=\"prev-icon\" theme={args.theme} name=\"plc\" size=\"base\" disabled={args.disabled} />} childrenPopUp={args.active && <MenuItem theme={args.theme} label=\"\u041A\u0430\u043A\u0430\u044F-\u0442\u043E \u043E\u043F\u0446\u0438\u044F\" hint=\"Ctrl + Shift + N\" showIcon showCollapseIcon>\n      </MenuItem>}></MenuItem>",
...
//# sourceMappingURL=stories-choice-menu-item-stories.d2ebee68aad9c04c0cab.hot-update.js.map